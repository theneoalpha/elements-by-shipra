...
export async function generateMetadata(): Promise<Metadata> {
  const meta = await sanityFetch<PageMeta>(pageMetadataQuery, { slug: "terms-of-service" }, { tags: ["sanity-pageMetadata"] });

  return {
    title: meta?.title ?? "Terms of Service",
...
export default async function TermsOfServicePage() {
  const page = await sanityFetch<LegalPageData>(legalPageQuery, { slug: "terms-of-service" }, { tags: ["sanity-legalPage"] });
